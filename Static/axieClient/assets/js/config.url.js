...
//登录接口
global_request_login="http://8.136.97.179:9501/user/login";

//账号管理接口
global_request_addAccount="http://8.136.97.179:9501/user/addAccount";

//宠物管理接口
global_request_addBaby="http://8.136.97.179:9501/user/addBaby";

//统计管理列表接口
global_request_get_statistics="http://8.136.97.179:9501/user/get_statistics";

//统计管理添加接口
global_request_addTodayTotal="http://8.136.97.179:9501/user/addTodayTotal";
